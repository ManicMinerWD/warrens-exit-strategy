...
const BALI_STRATEGY = {
  ...
  steps: [
    ...
    },
    {
      ...
      detail: "When the SG IBKR portfolio has grown enough, sell shares. The capital gain is taxed at 22% in Singapore (corporate holder; individual may be exempt if gains are capital in nature — confirm with SG tax adviser). The after-tax SGD proceeds are converted back to IDR and used to purchase another Bali villa — which counts as the capital investment towards the PT PMA's 10B IDR minimum paid-up capital / investment realisation requirement (KAP / government board). You can repeat this cycle: villa → rental → SG shares → sell → after-22%-tax proceeds → next villa — each new villa both grows the portfolio and satisfies the Indonesian capital investment requirement. The 10B IDR does not need to be a single lump sum invested once — it is the total capital invested in the business over the investment period (subject to the 3-year / extendable 4-5-year timeline).",
      caveat: "This is the loop-closer: it connects the SG capital gains regime back to the Indonesian PT PMA capital investment requirement. Must be confirmed with Indonesian counsel (does buying a villa count as investing in the PT PMA? does the purchase price count dollar-for-dollar or at market value? does the timeline reset with each new villa?) and SG tax adviser (22% on gains, individual vs corporate holder, capital vs revenue characterisation, stamp duty / any SG property implications if buying through the SG entity). The 10B IDR figure and the KAP investment realisation deadline must both be confirmed with Indonesian counsel — do not assume the villa purchase automatically counts."
    },
    {
